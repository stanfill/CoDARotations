...
\if0\blind
{
  ...
  \author{Bryan Stanfill\thanks{
    The authors gratefully acknowledge the valuable suggestions made by reviewers and the associate editor that have helped strengthening this manuscript.}\hspace{.2cm}\\
    Ulrike Genschel \\
    and\\
    Heike Hofmann\\
