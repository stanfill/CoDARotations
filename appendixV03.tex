...
\begin{table}[ht]
\caption{Numerical summaries of the estimation error  by distribution and circular variance $\nu$ for $n=100$.  The mean error (standard deviation) and RMSE are reported here.}  \label{tab:alldN100Nu25}
\centering
\scalebox{.8}{
...
\begin{tabular}{rrcrrrcrrrcrrr}
  ...
  %&&&\multicolumn{3}{c}{} & &\multicolumn{3}{c}{\textbf{matrix} } &&\multicolumn{3}{c}{\textbf{circular-}}\\
    &&&\multicolumn{3}{c}{\textbf{Cayley}} & &\multicolumn{3}{c}{\textbf{matrix Fisher}} & &\multicolumn{3}{c}{\textbf{circular-von Mises}}\\ 
\rule[2mm]{0mm}{3mm} 
  $\nu$&  $n$ && $\bar{\delta}$&SE($\bar\delta$) & \% & & $\bar{\delta}$&SE($\bar\delta$) & \% & & $\bar{\delta}$&SE($\bar\delta$) & \% \\ 
  \hline \hline
\multirow{4}{*}{0.25}  &    10 && 0.0078 & 0.0004 & 0.7430 && 0.0060 & 0.0004 & 0.7250 && -0.0053 & 0.0006 & 0.3280 \\ 
...
\hline
\multirow{4}{*}{0.50}    &    10 && 0.0315 & 0.0016 & 0.7720 && 0.0171 & 0.0017 & 0.6620 && -0.0192 & 0.0020 & 0.3350 \\ 
...
\multirow{4}{*}{0.75}   &    10 && 0.0895 & 0.0042 & 0.8210 && 0.0340 & 0.0040 & 0.6330 && -0.0396 & 0.0062 & 0.3220 \\ 
...
$\nu$  &  $n$ && $\bar{\delta}$&SE($\bar\delta$) & \% & & $\bar{\delta}$&SE($\bar\delta$) & \% & & $\bar{\delta}$&SE($\bar\delta$) & \% \\  
  \hline \hline
\multirow{4}{*}{0.25} &    10 && 0.0011 & 0.0004 & 0.5210 && -0.0016 & 0.0005 & 0.4500 && -0.0344 & 0.0030 & 0.1280 \\ 
...
\multirow{4}{*}{0.50}  &    10 && 0.0099 & 0.0013 & 0.5920 && -0.0178 & 0.0027 & 0.4340 && -0.1011 & 0.0051 & 0.1570 \\ 
...
\multirow{4}{*}{0.75}  &    10 && 0.0163 & 0.0062 & 0.6680 && -0.0958 & 0.0105 & 0.3570 && -0.2101 & 0.0113 & 0.1710 \\ 
