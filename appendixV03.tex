...
In Table \ref{tab:alldN100} we present the tabular results corresponding to Figure \ref{fig:vmnu75} with additional results corresponding to the Cayley and matrix Fisher distributions.  The mean error across simulations along with the standard error estimate are given as well as an estimate of the root mean square error, RMSE.
...
In Table \ref{tab:vmnu75} we give a tabular account of Figure \ref{}
