...
\noindent Note that for any two rotations $\bm R_1$ and $\bm R_2$ in $SO(3)$ $\Edist(\bm R_1,\bm R_2)=2\sqrt{2}\sin[\Rdist(\bm R_1,\bm R_2)/2]$. We refer to Section~\ref{sec:appendix2} of the appendix for a short proof of this result.  Hence, our results using $\Edist$ would prove equivalent, albeit on a smaller scale.   
