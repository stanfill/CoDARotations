...
Section~\ref{subsec:simdesign} outlines the simulation design. %and Section~\ref{subsec:algorithms} provides the algorithms used for numerically evaluating the location estimators of Section~\ref{sec:estimators}.
