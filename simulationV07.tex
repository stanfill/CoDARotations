...
\caption{Comparison of the distributions of interest for $\nu=0.75$.  Clearly the circular-von Mises based-distribution has the highest peak, and surprisingly it has the heavies tail as well.}
\label{fig:Haar}
\end{figure}
