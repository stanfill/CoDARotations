...
%   \subfloat[Sphere plot of $y$-axis. ] 
   ...
   \caption{ \label{fig:pcp} Parallel coordinated plot (a) on the left, and a sphere plot of the $y$ axis (b) on the right show all fourteen rotation matrices of table \ref{tab:rotations}, the location with the largest angle difference between projected mean and median estimator. }
\end{figure}
