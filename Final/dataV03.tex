...
\begin{figure}[h!] %  figure placement: here, top, bottom, or page
   \centering
%   \vspace{-.45in}
   \subfloat[\hh{Shading reflects angle between  $\ProjMedian$ and $\bm I_{3\times 3}$}][c]{\includegraphics[width=.49\textwidth]{images/grain-map.pdf}} \hfill
   \subfloat[\hh{Location shaded by angle (in degrees) between  $\ProjMedian$ and $\ProjMean$. Distances of 0.5$^\circ$ or more are generally considered to suggest different main orientations. Note that the mapping of distance to color shading is on a square-root scale.}][c]{\includegraphics[width=.49\textwidth]{images/grain-diff.pdf}}
%    \vspace{-.175in} 
