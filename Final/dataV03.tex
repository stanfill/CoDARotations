...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \caption{ \label{fig:pcp} Parallel coordinate plot (a), and a sphere plot of the $y$ axis (b) show all fourteen rotation matrices of table \ref{tab:rotations}, the location with the largest angle difference between projected mean and median estimator. }
\end{figure}
