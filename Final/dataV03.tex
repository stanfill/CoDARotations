...
\begin{figure}[h!] %  figure placement: here, top, bottom, or page
   \centering
%   \vspace{-.45in}
   \subfloat[{Shading reflects angle between  $\ProjMedian$ and $\bm I_{3\times 3}$}]{\includegraphics[width=.4\textwidth]{images/grain-map-wo.pdf}\includegraphics[width=.06\textwidth]{images/grain-map-legend.pdf}} \hfill
...
The scans have been re-ordered to better illustrate  the clustering of the rotations observed at this particular location. \red{This clustering is also visible in the parallel coordinate plot in Figure \ref{fig:pcp}}. 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \subfloat[Sphere plot of $y$-axis. ]{\includegraphics[height=.325\textwidth]{images/eye-698-2.pdf}}
