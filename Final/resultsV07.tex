...
\begin{figure}[h!]
\centering
\subfloat[$\nu=0.25$]{\includegraphics[width=0.8\linewidth]{EuclidRiemannNu25.pdf}}\\
\subfloat[$\nu=0.75$]{\includegraphics[width=0.8\linewidth]{EuclidRiemannNu75.pdf}}
