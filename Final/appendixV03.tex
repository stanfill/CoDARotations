...
\subsection{\red{Convergence of $\ProjMedian$ Algorithm}}
\red{
...
\[
\ProjMedian=\argmin_{\bm S\in SO(3)}||\MMedian-\bm S||_F=\argmin_{\bm S\in SO(3)}\sum_{i=1}^n||\bm R_i-\bm S||_F.
\]

\noindent\textit{Proof:}  Suppose $\ProjMedian^*\neq\ProjMedian$ and $\ProjMedian^*$ is the projection of $\MMedian$ into $SO(3)$, i.e. $\ProjMedian^*=\argmin_{\bm S\in SO(3)}||\MMedian-\bm S||_F$.  For any $i$,
\[
||\bm R_i-\ProjMedian||_F=||\bm R_i-\MMedian+\MMedian-\ProjMedian||_F\leq||\bm R_i-\MMedian||_F+||\MMedian-\ProjMedian||_F.
\]
Also, by definition of $\ProjMedian$, $\sum_{i=1}^n||\bm R_i-\ProjMedian||_F<\sum_{i=1}^n||\bm R_i-\ProjMedian^*||_F$.  Therefore,

\begin{align}\label{eq:contradiction}
0&<\sum_{i=1}^n||\bm R_i-\ProjMedian^*||_F-\sum_{i=1}^n||\bm R_i-\ProjMedian||_F\nonumber\\
&\leq\sum_{i=1}^n\left(||\bm R_i-\MMedian||_F+||\MMedian-\ProjMedian^*||_F-||\bm R_i-\MMedian||_F-||\MMedian-\ProjMedian||_F\right)\nonumber\\
&=||\MMedian-\ProjMedian^*||_F-||\MMedian-\ProjMedian||_F\nonumber\\
\implies0&<||\MMedian-\ProjMedian^*||_F-||\MMedian-\ProjMedian||_F
\end{align}
In turn \eqref{eq:contradiction} implies $||\MMedian-\ProjMedian||_F<||\MMedian-\ProjMedian^*||_F$, which is a contradiction by the definition of $\ProjMedian^*$.  The result follows.
}
...
\begin{figure}
\centering
\subfloat[x axis]{\includegraphics[width=.3\linewidth]{eye-cayley.png}}
\subfloat[y axis]{\includegraphics[width=.3\linewidth]{eye-cayley-2.png}}
\subfloat[z axis]{\includegraphics[width=.3\linewidth]{eye-cayley-3.png}}
...
\begin{figure}
\centering
\subfloat[x axis]{\includegraphics[width=.3\linewidth]{eye-fisher.png}}
\subfloat[y axis]{\includegraphics[width=.3\linewidth]{eye-fisher-2.png}}
\subfloat[z axis]{\includegraphics[width=.3\linewidth]{eye-fisher-3.png}}
...
\begin{figure}
\centering
\subfloat[x axis]{\includegraphics[width=.3\linewidth]{eye-vmises.png}}
\subfloat[y axis]{\includegraphics[width=.3\linewidth]{eye-vmises-2.png}}
\subfloat[z axis]{\includegraphics[width=.3\linewidth]{eye-vmises-3.png}}
