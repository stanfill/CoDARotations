...
In Figure 7 of the main manuscript we examined how the choice of geometry (Riemannian versus Euclidean) affected the estimation error under both types of loss functions $L
_1$ and $L_
