...
The data in our example represent the orientations of cubic crystals on a Nickel surface measured by electron backscatter diffraction. The data were obtained using a 14-fold technical replicate in each location. \red{how many locations?}
...
The left hand side of Figure~\ref{fig:grain-map} displays a map of the surface colored by the size of the angle between the projected median $\ProjMedian$ and the identity $\bm I_{3\times 3}$ in each location showing distinct spatial structures.
