...
\end{center}
\end{table}
Applying each estimators to all surface location reveals noticeable differences between the estimates in some of the locations. The right hand side of Figure~\ref{fig:grain-map}, for example shows the differences in angles between the $\ProjMedian$ and $\ProjMean$ estimate for each location. Differences are largest along the grain boundaries shown on the left of Figure~\ref{fig:grain-map}.
